...
import static djf.components.AppStyleComponent.CLASS_APP_PANE;
import static djf.settings.AppPropertyType.*;
import static djf.settings.AppStartupConstants.FILE_PROTOCOL;
import static djf.settings.AppStartupConstants.PATH_IMAGES;
import static djf.components.AppStyleComponent.CLASS_BORDERED_PANE;
import static djf.components.AppStyleComponent.CLASS_BORDERED_PANE1;
import static djf.components.AppStyleComponent.CLASS_BORDERED_PANE2;
...
public class AppGUI {
    ...
    protected HBox fileToolbarPane1;
    protected HBox fileToolbarPane2;
    ...
    private void initFileToolbar(AppTemplate app) {
        ...
        fileToolbarPane1 = new HBox();
        fileToolbarPane2 = new HBox();

        // HERE ARE OUR FILE TOOLBAR BUTTONS, NOTE THAT SOME WILL
        // START AS ENABLED (false), WHILE OTHERS DISABLED (true)
        newButton = initChildButton(fileToolbarPane1, NEW_ICON.toString(), NEW_TOOLTIP.toString(), false);
        loadButton = initChildButton(fileToolbarPane1, LOAD_ICON.toString(), LOAD_TOOLTIP.toString(), false);
        saveButton = initChildButton(fileToolbarPane1, SAVE_ICON.toString(), SAVE_TOOLTIP.toString(), true);
        saveAsButton = initChildButton(fileToolbarPane1, SAVE_AS_ICON.toString(), SAVE_AS_TOOLTIP.toString(), true);
        exportButton = initChildButton(fileToolbarPane1, EXPORT_ICON.toString(), EXPORT_TOOLTIP.toString(), true);
        exitButton = initChildButton(fileToolbarPane1, EXIT_ICON.toString(), EXIT_TOOLTIP.toString(), false);
        undoButton = initChildButton(fileToolbarPane2, UNDO_ICON.toString(), UNDO_TOOLTIP.toString(), false);
        redoButton = initChildButton(fileToolbarPane2, REDO_ICON.toString(), REDO_TOOLTIP.toString(), false);
        aboutButton = initChildButton(fileToolbarPane2, ABOUT_ICON.toString(), ABOUT_TOOLTIP.toString(), false);
        fileToolbarPane.getChildren().addAll(fileToolbarPane1, fileToolbarPane2);
        fileToolbarPane1.prefWidthProperty().bind(fileToolbarPane.widthProperty().multiply(.3));
        fileToolbarPane2.prefWidthProperty().bind(fileToolbarPane.widthProperty().multiply(.7));
        fileToolbarPane1.prefHeightProperty().bind(fileToolbarPane.heightProperty());
        fileToolbarPane2.prefHeightProperty().bind(fileToolbarPane.heightProperty());
    ...
    public void initFileToolbarStyle() {
        appPane.getStyleClass().add(CLASS_APP_PANE);
        fileToolbarPane.getStyleClass().add(CLASS_BORDERED_PANE);
        fileToolbarPane1.getStyleClass().add(CLASS_BORDERED_PANE1);
        fileToolbarPane2.getStyleClass().add(CLASS_BORDERED_PANE2);
