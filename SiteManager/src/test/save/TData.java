 ...
 */
public class TData implements AppDataComponent {
 ...
 //   private static jTPS jTPS;
    ...
    ObservableList<TSlot> timeSlots;
 ...
 //   ArrayList<String> gridHeaders;
    ...
    private String startMondayDay;
    private String startMondayMonth;
    private String startMondayYear;
    private String endFridayDay;
    private String endFridayMonth;
    private String endFridayYear;
    ...
    public TData() {
       ...
       endFridayYear = "2018";
        ...
        ci = new CourseInfo("CSE", "Spring", "308", "2017", "Software Engineering", "Richard McKenna", "216 New Computer Science Building");
...
//    }
    ...
    public ObservableList getTimeSlots() {
        return timeSlots;
    }
...
//                TData data = (TData) app.getDataComponent();
...
//    }
    ...
    /**
     * @return the startMondayDay
     */
    public String getStartMondayDay() {
        return startMondayDay;
    }

    /**
     * @param startMondayDay the startMondayDay to set
     */
    public void setStartMondayDay(String startMondayDay) {
        this.startMondayDay = startMondayDay;
    }

    /**
     * @return the startMondayMonth
     */
    public String getStartMondayMonth() {
        return startMondayMonth;
    }

    /**
     * @param startMondayMonth the startMondayMonth to set
     */
    public void setStartMondayMonth(String startMondayMonth) {
        this.startMondayMonth = startMondayMonth;
    }

    /**
     * @return the startMondayYear
     */
    public String getStartMondayYear() {
        return startMondayYear;
    }

    /**
     * @param startMondayYear the startMondayYear to set
     */
    public void setStartMondayYear(String startMondayYear) {
        this.startMondayYear = startMondayYear;
    }

    /**
     * @return the endFridayDay
     */
    public String getEndFridayDay() {
        return endFridayDay;
    }

    /**
     * @param endFridayDay the endFridayDay to set
     */
    public void setEndFridayDay(String endFridayDay) {
        this.endFridayDay = endFridayDay;
    }

    /**
     * @return the endFridayMonth
     */
    public String getEndFridayMonth() {
        return endFridayMonth;
    }

    /**
     * @param endFridayMonth the endFridayMonth to set
     */
    public void setEndFridayMonth(String endFridayMonth) {
        this.endFridayMonth = endFridayMonth;
    }

    /**
     * @return the endFridayYear
     */
    public String getEndFridayYear() {
        return endFridayYear;
    }

    /**
     * @param endFridayYear the endFridayYear to set
     */
    public void setEndFridayYear(String endFridayYear) {
        this.endFridayYear = endFridayYear;
    }

    /**
     * @return the ci
     */
    public CourseInfo getCi() {
        return ci;
    }
     ...
     */
    public void setCi(CourseInfo ci) {
        this.ci = ci;
    }
