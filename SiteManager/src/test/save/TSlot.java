...
public class TSlot {
    ...
    public TSlot(String initDay, String initTime, String initName) {
        day = initDay;
        time = initTime;
        name = initName;
    }
     ...
     * JSON file.
     */
//    public static ArrayList<TimeSlot> buildOfficeHoursList(TData data) {
...
//                        TSlot ts = new TSlot(day, time, taName);
